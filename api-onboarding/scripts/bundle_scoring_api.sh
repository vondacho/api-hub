...
#   SPEC_DIR          root of contract sources        (default: src/main/resources/api/scoring)
#   OVERLAY_DIR       directory of overlay documents  (default: src/test/resources/api/scoring)
...
SPEC_DIR="${SPEC_DIR:-src/main/resources/api/scoring}"
OVERLAY_DIR="${OVERLAY_DIR:-src/test/resources/api/scoring}"
