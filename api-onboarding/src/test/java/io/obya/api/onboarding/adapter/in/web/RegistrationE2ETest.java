...
class RegistrationE2ETest {
    ...
    static void importSpecification() throws MicrocksException, IOException {
        ...
        microcksContainer.importAsSecondaryArtifact(new File(
                "target/test-classes/api/scoring/scoring_v1.metadata.yaml"));
    }
    ...
    @Test
    void should_onboarding_usecase_be_conformant_with_contract() throws MicrocksException, IOException {
